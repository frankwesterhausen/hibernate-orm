...
import org.hibernate.envers.ant.XmlConfigurationTask;

/**
 * @author Adam Warski (adam at warski dot org)
 */
public class EnversXmlHibernateToolTask extends HibernateToolTask {
   ...
   //TODO: IS IT OK TO OVERWRITE ??? DEFINE A COMPLETE NEW TASK FOR THE XML BASED GENERATION

   public ConfigurationTask createConfiguration() {
      checkConfiguration();
      System.out.println("createConfiguration()");
      XmlConfigurationTask task = new XmlConfigurationTask();
      configurationTask = task;
      return task;
   }
